...
public class HlwStudentCtrl {
    ...
    IdRo add(@RequestBody final HlwStudentMo mo) throws Exception {
        _log.info("received post:/hlw/student");
        _log.info("studentCtrl.add: {}", mo);
    ...
    Ro modify(@RequestBody final HlwStudentMo mo) throws Exception {
        _log.info("received put:/hlw/student");
        _log.info("studentCtrl.modify: {}", mo);
        try {
            if (svc.modify(mo) == 1) {
    ...
    Ro del(@RequestParam("id") final java.lang.Long id) {
        _log.info("received delete:/hlw/student");
        _log.info("studentCtrl.del: {}", id);
